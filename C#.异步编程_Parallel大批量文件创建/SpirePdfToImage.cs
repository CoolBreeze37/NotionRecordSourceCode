...
{
    internal class SpirePdfToImage
    {
        public static void  Convert()
        {
            ...
            // 加载示例PDF文档
            pdf.LoadFromFile("D:\\Desktop\\PdftoPng\\DH_8105D720817_48689464_HMHMM9V0BX001_HMHMM9V0BX_3_S_NOPLATE.pdf");

            // 循环遍历文档的所有页面
            for (int pageIndex = 1; pageIndex <= pdf.Pages.Count; pageIndex++)
            {
                // 将所有页面转换为图像并设置图像Dpi
                Image image = pdf.SaveAsImage(pageIndex, PdfImageType.Metafile, 500, 500);

                // 将图像以PNG格式保存到指定的文件夹
                string file = $"D:\\Desktop\\PdftoPng\\{pageIndex}.png";
